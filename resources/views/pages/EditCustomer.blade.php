...
<div class="container">
    ...
    <div class="layoutBody">
      <div class="form formAdd">
        <form class="form" method="POST" action="{{ route('edit.customer') }}" id="formPersonnel">
          @csrf
          <input type="hidden" name="id" value="{{ $customer->id }}">
            <div class="row hucregrup">
              <div class="col-md-12 form-group">
                <span>Firma adı:</span>
                <input name="name" id="customerName" class="form-control" type="text" value="{{ $customer->name }}">
              </div>
            </div>
            <div class="row hucregrup">
              <div class="col-md-6 form-group">
                <span>Telefon numarası:</span>
                <input name="tel_no" id="telNo" class="form-control" type="text" value="{{ $customer->tel_no }}">
              </div>
              <div class="col-md-6 form-group">
                <span>E posta:</span>
                <input name="email" id="email" class="form-control" type="text" value="{{ $customer->email }}">
              </div>
            </div>
              ...
              <div class="col-md-6 form-group">
                ...
                <input name="customer_no" id="customerNo" class="form-control" type="text" value="{{ $customer->customer_no }}">
              </div>
              <div class="col-md-6 form-group">
                <span>Yetkili ad soyad:</span>
                <input name="owner_name" id="owner_name" class="form-control" type="text" value="{{ $customer->owner_name }}">
              </div>
            ...
            <div class="row hucregrup">
              ...
              <div class="col-md-12 form-group">
                <span>Adres:</span>
                <textarea name="adress" id="adress" class="form-control" rows="3">{{ $customer->adress }}</textarea>
              </div>
            </div>
        </form>
      </div>
